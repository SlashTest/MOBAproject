module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitles = [
            "狄某有话说 |  峡谷送温暖？！元芳正在看着你",
            "周年庆表现道具设计大赛人气Top20作者采访",
            "周年庆表现道具设计大赛优秀创意采访：带你走进奇幻梦境！",
            "稷下学院突现神秘卡片，受到伤害后竟……",
    ...
    router.get('/heroes/list', async (req, res) => {
        ...
        const cats = await Category.aggregate([//多了解下
            { $match: { parent: parent._id } },
            {
                $lookup: {
                    from: 'heroes',
